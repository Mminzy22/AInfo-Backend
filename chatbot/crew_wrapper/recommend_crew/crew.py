...
from chatbot.crew_wrapper.recommend_crew.agents import (
    rag_search_agent,
    recommendation_agent,
)
from chatbot.crew_wrapper.recommend_crew.tasks.generate_recommendation_task import (
    create_recommendation_task,
)
from chatbot.crew_wrapper.recommend_crew.tasks.rag_search_task import (
...
def create_recommend_crew(user_input: dict) -> Crew:
    ...
    recommendation_task = create_recommendation_task(
        agent=recommendation_agent, user_input=user_input, rag_task=rag_task
    )
