...
CLASSIFICATION_PROMPT = ChatPromptTemplate.from_messages(
    [
        SystemMessagePromptTemplate.from_template(
            ...
            3. **Extract 2~5 relevant Korean keywords** from the input.
                - Return only 핵심 명사/주요 단어 that can be used for document search, metadata filtering, or web queries.
                - Do not include stopwords, particles, or full sentences.
            ...
            - "청년 창업 지원금 뭐 있어?" → <"category": "gov_policy", ..., "keywords": ["청년", "창업", "지원금"]>
